...
<%@ Register Src="~/controls/AdmUser.ascx" TagName="AdmUser" TagPrefix="vit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderCenter" runat="Server">
    <vit:TabCaptions ID="TabCaptions1" runat="server">
        <vit:TabCaption Name="Пользователи" Href="~/admin/User.aspx" Selected="true" />
        <vit:TabCaption Name="Контактная информация пользователей" Href="~/admin/ContactUser.aspx" Selected="false" />
    </vit:TabCaptions>
    <br />
    <vit:AdmUser ID="AdmUser1" runat="server" />
</asp:Content>
